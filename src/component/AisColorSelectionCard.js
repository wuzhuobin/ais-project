  ...
  render() {
    ...
    return (
      <Card className={this.props.affected ? 'Affected' : 'UnAffected'} title={<div className='Title'>{this.props.orientation === ORIENTATION.LEFT ? t('LEFT'): t('RIGHT')}</div>}>
        <div className={['TableItem', 'C'  + (this.props.affected ? 'Affected' : 'UnAffected')].join(' ')}>{t("C")}&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;<mark className={this.context.infoAis.ASPECT_Score[scores[0]] == 1 ? 'markIsAIS' : 'markIsNotAIS'}>{this.context.infoAis.HU_Mean[means[0]]}</mark></div>
        <div className={['TableItem', 'IC' + (this.props.affected ? 'Affected' : 'UnAffected')].join(' ')}>{t("IC")}&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;<mark className={this.context.infoAis.ASPECT_Score[scores[1]] == 1 ? 'markIsAIS' : 'markIsNotAIS'}>{this.context.infoAis.HU_Mean[means[1]]}</mark></div>
        <div className={['TableItem', 'L'  + (this.props.affected ? 'Affected' : 'UnAffected')].join(' ')}>{t("L")}&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;<mark className={this.context.infoAis.ASPECT_Score[scores[2]] == 1 ? 'markIsAIS' : 'markIsNotAIS'}>{this.context.infoAis.HU_Mean[means[2]]}</mark></div>
        <div className={['TableItem', 'I'  + (this.props.affected ? 'Affected' : 'UnAffected')].join(' ')}>{t("I")}&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;<mark className={this.context.infoAis.ASPECT_Score[scores[3]] == 1 ? 'markIsAIS' : 'markIsNotAIS'}>{this.context.infoAis.HU_Mean[means[3]]}</mark></div>
        <div><br/></div>
